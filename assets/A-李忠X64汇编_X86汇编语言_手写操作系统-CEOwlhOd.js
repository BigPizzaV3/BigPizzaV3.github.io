const n=`---
id: 1453
title: "A-李忠X64汇编+X86汇编语言&手写操作系统"
year: 2026
...
tags:
  - "逆向工程"
  - AList采集
description: "本课程根据 AList 采集目录自动整理，原始目录路径为 /二进制逆向&驱动内核板块（新）/A-李忠X64汇编+X86汇编语言&手写操作系统。章节来自远程课程目录结构，适合先浏览完整目录后再联系宝箱管理员获取资料。"
reviewCount: '0'
studentCount: '0'
---
...
原始路径：/二进制逆向&驱动内核板块（新）/A-李忠X64汇编+X86汇编语言&手写操作系统
...
### 第 1 阶段: X64架构汇编语言和操作系统基础

- X64架构汇编语言和操作系统基础 目录

### 第 2 阶段: X86汇编保护模式到实模式
