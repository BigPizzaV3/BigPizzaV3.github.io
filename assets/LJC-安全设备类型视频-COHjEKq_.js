...
tags:
  - "网络安全"
  - AList采集
description: "本课程根据 AList 采集目录自动整理，原始目录路径为 /安全板块目录/LJC-安全设备类型视频。章节来自远程课程目录结构，适合先浏览完整目录后再联系宝箱管理员获取资料。"
reviewCount: '0'
studentCount: '0'
---
...
- [doc] 1、天眼使用指南.pdf | 8.74MB
- [doc] 2、常见协议字段及语法.pdf | 3.60MB
- [doc] 3、天眼告警监测分析.pdf | 12.79MB
- [doc] 4、场景一.pdf | 4.32MB
- [doc] 5、场景二.pdf | 4.76MB

## 资料

- 安恒WAF_ev .dmm | 课程资料
- 天眼&NGSOC告警分析（上）_ev .dmm | 课程资料
- 天眼&NGSOC告警分析（下）_ev .dmm | 课程资料
