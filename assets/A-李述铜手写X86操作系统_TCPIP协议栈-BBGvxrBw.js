...
tags:
  - "逆向工程"
  - AList采集
description: "本课程根据 AList 采集目录自动整理，原始目录路径为 /二进制逆向&驱动内核板块（新）/A-李述铜手写X86操作系统+TCPIP协议栈。章节来自远程课程目录结构，适合先浏览完整目录后再联系宝箱管理员获取资料。"
reviewCount: '0'
studentCount: '0'
---
...
原始路径：/二进制逆向&驱动内核板块（新）/A-李述铜手写X86操作系统+TCPIP协议栈
...
### 第 1 阶段: 从0写自己的Linux x86操作系统

- 从0写自己的Linux x86操作系统 目录

### 第 2 阶段: 用10000+行代码从0写TCP-IP协议栈

- 用10000+行代码从0写TCP-IP协议栈 目录

### 第 3 阶段: 自己动手写x86操作系统环境
