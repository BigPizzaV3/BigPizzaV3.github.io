const n=`---
id: 1455
title: "A-麦洛克菲高级内核12期（2017）（完整版）（0水印）（未加密）"
year: 2026
...
tags:
  - "逆向工程"
  - AList采集
description: "本课程根据 AList 采集目录自动整理，原始目录路径为 /二进制逆向&驱动内核板块（新）/A-麦洛克菲高级内核12期（2017）（完整版）（0水印）（未加密）。章节来自远程课程目录结构，适合先浏览完整目录后再联系宝箱管理员获取资料。"
reviewCount: '0'
studentCount: '0'
---
...
原始路径：/二进制逆向&驱动内核板块（新）/A-麦洛克菲高级内核12期（2017）（完整版）（0水印）（未加密）
...
- 6sevenl-sfilter.rar | 课程资料
- linux-2.6.32.65.tar.xz | 课程资料
- ubuntu-10.04-desktop-amd64.iso | 课程资料
- Windows 7 SP1 x86.7z | 课程资料
- 课件1.rar | 课程资料
- 课件2.rar | 课程资料
- 密码.txt | 课程资料
