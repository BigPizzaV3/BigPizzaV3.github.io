const n=`---
id: 1464
title: "A-易锦 Windows逆向之恶意代码分析（2024）"
year: 2026
...
tags:
  - "逆向工程"
  - AList采集
description: "本课程根据 AList 采集目录自动整理，原始目录路径为 /二进制逆向&驱动内核板块（新）/A-易锦 Windows逆向之恶意代码分析（2024）。章节来自远程课程目录结构，适合先浏览完整目录后再联系宝箱管理员获取资料。"
reviewCount: '0'
studentCount: '0'
---
...
原始路径：/二进制逆向&驱动内核板块（新）/A-易锦 Windows逆向之恶意代码分析（2024）
...
### 第 4 阶段: 4.第四章 恶意代码分析环境搭建

- 4.第四章 恶意代码分析环境搭建 目录

### 第 5 阶段: 5.第五章 恶意代码静态分析

- 5.第五章 恶意代码静态分析 目录

### 第 6 阶段: 6.第六章 x86汇编与指令
