const n=`---
id: 1062
title: "CTF-FuzzingLab专题3：内核Fuzz入门"
year: 2026
subtitle: "采集自 安全板块目录"
instructor: "课小猫的秘密宝箱"
...
tags:
  - "网络安全"
  - AList采集
description: "本课程根据 AList 采集目录自动整理，原始目录路径为 /安全板块目录/CTF-FuzzingLab专题3：内核Fuzz入门。章节来自远程课程目录结构，适合先浏览完整目录后再联系宝箱管理员获取资料。"
reviewCount: '0'
studentCount: '0'
---
...
原始路径：/安全板块目录/CTF-FuzzingLab专题3：内核Fuzz入门
...
- [doc] 内核Fuzz入门.7z | 92.40KB
- [doc] week1 (1).7z | 687.29KB
- [doc] week2 (1).7z | 1.58MB
- [doc] week3.7z | 829.72KB

### 第 2 阶段: 录屏

- week1：Linux内核漏洞挖掘基础和Fuzz基础 .dmm | 268.47MB
- week2：syzkaller的配置和使用，以及如何fuzz指定版本的内核 .dmm | 199.52MB
- week3：syzlang模板编写 .dmm | 195.06MB
- week4：syzkaller源码调试与学习 .dmm | 119.06MB
